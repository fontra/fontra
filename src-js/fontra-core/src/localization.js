...
export const languages = [
  ...
  { code: "it", langEn: "Italian", langLang: "Italiano", status: "wip" },
  {
    code: "es-ES",
    langEn: "Spanish (Spain)",
    langLang: "Español (España)",
    status: "beta",
  },
  {
    code: "es-419",
    langEn: "Spanish (Latin America)",
    langLang: "Español (Latinoamérica)",
    status: "beta",
  },
  {
    code: "pt-BR",
