...
export const strings = {
  ...
  "action.add-guideline-between-points": "在两点间添加参考线",
  "action.break-contour": "断开轮廓",
  "action.break-contour.plural": "断开轮廓",
  "action.close-contour": "闭合轮廓",
  "action.close-contour.plural": "闭合 %0 个轮廓",
  "action.copy": "复制",
  "action.copy-character": "复制字符",
  "action.copy-character.plural": "复制字符",
  "action.copy-glyphname": "复制字形名称",
  "action.copy-glyphname.plural": "复制字形名称",
  "action.cut": "剪切",
  ...
  "action.glyph.convert-curves": "转换曲线类型",
  "action.glyph.convert-curves-to-cubic": "转换为三次曲线",
  "action.glyph.convert-curves-to-quadratic-1": "转换为二次曲线（1 个控制点）",
  "action.glyph.convert-curves-to-quadratic-2": "转换为二次曲线（2 个控制点）",
  "action.glyph.convert-curves-to-quadratic-3": "转换为二次曲线（3 个控制点）",
  "action.glyph.convert-curves-to-quadratic-4": "转换为二次曲线（4 个控制点）",
  "action.glyph.convert-curves-to-quadratic-5": "转换为二次曲线（5 个控制点）",
  ...
  "conditional-substitutions.rule.new": "新建条件替换规则",
  ...
  "development-status-definitions.tooltip.is-default":
    "选中后，未设置开发状态的源会默认使用该标签",
  "development-status-definitions.undo.change": "更改状态标签",
  "development-status-definitions.undo.change-is-default": "更改状态标签默认设置",
  ...
  "editor.kerning-tool": "字偶距调节工具",
  "editor.knife-tool": "切割工具",
  "editor.pen-tool": "钢笔工具",
  "editor.pen-tool-cubic": "钢笔工具（三次曲线）",
  "editor.pen-tool-quad": "钢笔工具（二次曲线）",
  ...
  "editor.sidebearing-tool": "字边距调节工具",
  ...
  "font-overview.dialog.label.suffix": "后缀",
  "font-overview.dialog.no-glyphs-found": "（未找到字形）",
  "font-overview.dialog.option.add-suffix-to-all-pasted":
    "为所有粘贴的字形名称添加后缀",
  "font-overview.dialog.option.add-suffix-to-duplicates": "为所有重复字形名称添加后缀",
  "font-overview.dialog.option.replace-existing-glyphs": "替换现有字形",
  "font-overview.dialog.replace-existing-glyphs": "替换现有字形？",
  "font-overview.popup.source": "源",
  "font-overview.title": "字体概览",
  "glyph-organizing.glyph-set.add-custom-glyph-set": "添加自定义字形集",
  "glyph-organizing.glyph-set.add-custom-glyph-set.menu-title": "添加自定义字形集...",
  "glyph-organizing.glyph-set.add-remove-glyph-set": "添加/移除预设字形集",
  "glyph-organizing.glyph-set.collection": "集合",
  "glyph-organizing.glyph-set.copy-to": "复制到“%0”",
  "glyph-organizing.glyph-set.edit": "编辑字形集",
  "glyph-organizing.glyph-set.reload": "重新加载",
  "glyph-organizing.glyph-set.source-link": "来源",
  "glyph-organizing.group-by": "分组方式",
  "glyph-organizing.group-by.block": "区块",
  "glyph-organizing.group-by.case": "大小写",
  "glyph-organizing.group-by.category": "分类",
  "glyph-organizing.group-by.glyphname-extension": "字形名后缀",
  "glyph-organizing.group-by.script": "书写系统",
  "glyph-organizing.group-by.sub-category": "子分类",
  "glyph-organizing.my-glyph-sets": "我的字形集",
  "glyph-organizing.project-glyph-sets": "项目字形集",
  "glyph-organizing.this-fonts-glyphs": "此字体所含字形",
  ...
  "selection.none": "（未选择）",
  "shortcuts.dialog.reset-all.content": "你确定要将所有快捷键重置为默认设置吗？",
  ...
  "sidebar.characters-glyphs.advance": "步进",
  "sidebar.characters-glyphs.cluster": "簇",
  ...
  "sidebar.characters-glyphs.unicode-name": "Unicode 名称",
  "sidebar.designspace-navigation": "Designspace 导航",
  "sidebar.designspace-navigation.copy-current-layer": "复制当前图层",
  ...
  "sidebar.designspace-navigation.glyph-sources-sort-options": "排序选项",
  ...
  "sidebar.designspace-navigation.glyph-sources.status": "标签",
  "sidebar.designspace-navigation.hidden-font-axes": "隐藏字体轴",
  "sidebar.designspace-navigation.source-layer-name-must-be-unique": "图层名不可重复",
  ...
  "sidebar.reference-font.warning.could-not-store": "无法储存部分参考字体",
  ...
  "sidebar.selection-info.kern-group-l-r": "字偶分组(左/右)",
  "sidebar.selection-info.multi-source": "多源编辑参数轴值时使用绝对值",
  "sidebar.selection-info.sidebearings": "字边距",
  ...
  "sidebar.text-entry.apply-text-shaping": "应用文字成形及特性",
  "sidebar.text-entry.automatic": "自动",
  "sidebar.text-entry.direction": "方向",
  "sidebar.text-entry.direction.left-to-right": "从左至右",
  "sidebar.text-entry.direction.right-to-left": "从右至左",
  "sidebar.text-entry.reset-features": "重置 %0 特性设置",
  "sidebar.text-entry.script": "书写系统",
  "sidebar.text-entry.section.positioning": "定位",
  "sidebar.text-entry.section.positioning-from-font-data": "来自字体数据的定位",
  "sidebar.text-entry.section.substitution": "替换",
  "sidebar.text-entry.text-shaping-options": "文字成形选项",
  "sidebar.text-entry.text-shaping.options.tooltip": "额外文字成形选项",
  ...
  "sidebar.user-settings.glyph.kerning": "字偶距调节",
  "sidebar.user-settings.glyph.kerning-tool": "字偶距调节（工具）",
  ...
  "sidebar.user-settings.glyph.sidebearings": "非编辑字形的字边距",
  "sidebar.user-settings.glyph.sidebearings-tool": "字边距调节（工具）",
  ...
  "sources.dialog.delete.message": "删除字体源可能导致字偶距信息丢失或导致字形无效。",
  "sources.dialog.delete.title": "你确定要删除选中的字体源吗？",
  "sources.dialog.sparse-off.message": "这将会为此源添加自动插值的字偶距及度量线信息。",
  "sources.dialog.sparse-off.title": "你确定要关闭“次要”标记吗？",
  "sources.dialog.sparse-on.message": "这将会删除此源的字偶距及度量线信息。",
  "sources.dialog.sparse-on.title": "你确定要开启“次要”标记吗？",
