...
- [OpenType] Initial support for OpenType features has landed! This requires a longer explanation, but in short:
  ...
  - There are still some open issues, and things may still be a little rough around the edges. See [Issue 2381](https://github.com/fontra/fontra/issues/2381) for past and ongoing work, and related issues.
