...
describe('var-model tests', () => {
  ...
  describe('normalizeLocation tests', () => {
    it('-1,0,1', () => {
      ...
      expect(normalizeLocation({ wght: 100 }, axes)).to.deep.equal({
        wght: -1.0,
      });
      expect(normalizeLocation({ wght: 900 }, axes)).to.deep.equal({
        wght: 1.0,
      });
      expect(normalizeLocation({ wght: 650 }, axes)).to.deep.equal({
        wght: 0.5,
      });
      expect(normalizeLocation({ wght: 1000 }, axes)).to.deep.equal({
        wght: 1.0,
      });
    ...
    it('0,0,1', () => {
      ...
      expect(normalizeLocation({ wght: 500 }, axes)).to.deep.equal({
        wght: 0.5,
      });
      expect(normalizeLocation({ wght: 1001 }, axes)).to.deep.equal({
        wght: 1.0,
      });
    });
  ...
  describe('mapForward tests', () => {
    ...
    it('simple map', () => {
      ...
      expect(mapForward(location, axes)).to.deep.equal({
        weight: 150,
        width: 100,
      });
    });
  ...
  describe('mapBackward tests', () => {
    ...
    it('simple map', () => {
      ...
      expect(mapBackward(location, axes)).to.deep.equal({
        weight: 10,
        width: 100,
      });
    });
